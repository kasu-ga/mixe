...
import type {
  ...
  MySqlTableWithColumns as TableWithColumns,
  MySqlDatabase as BaseDatabase,
} from "drizzle-orm/mysql-core";
import { CodeData, Database, UserData } from "mixejs";

export class DrizzleMySqlAdapter extends Database {
  constructor(
...
export type MySqlSessionTable = TableWithColumns<{
  dialect: any;
  columns: {
    id: Column<
      {
...
export type MySqlCodeTable = TableWithColumns<{
  dialect: any;
  columns: {
    id: Column<
      {
...
export type MySqlUserTable = TableWithColumns<{
  dialect: any;
  name: any;
  schema: any;
  columns: {
