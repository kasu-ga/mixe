...
import type {
  PgColumn as Column,
  PgTableWithColumns as TableWithColumns,
  PgDatabase as BaseDatabase,
} from "drizzle-orm/pg-core";
import { CodeData, Database, UserData } from "mixejs";

export class DrizzlePgAdapter extends Database {
  constructor(
    db: BaseDatabase<any, any, any>,
    tables: {
      user: PgUserTable;
      session: PgSessionTable;
      code: PgCodeTable;
    }
  ) {
    super({
...
export type PgSessionTable = TableWithColumns<{
  dialect: any;
  columns: {
    id: Column<
      {
...
export type PgCodeTable = TableWithColumns<{
  dialect: any;
  columns: {
    id: Column<
      {
...
export type PgUserTable = TableWithColumns<{
  dialect: any;
  name: any;
  schema: any;
  columns: {
